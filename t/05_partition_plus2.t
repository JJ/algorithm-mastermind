...
BEGIN {
	use_ok( 'Algorithm::MasterMind::Partition_Plus2' );
}
...
my $solver = new Algorithm::MasterMind::Partition_Plus2 { alphabet => \@alphabet,
							   length => length( $secret_code ) };

isa_ok( $solver, 'Algorithm::MasterMind::Partition_Plus2', 'Instance OK' );
