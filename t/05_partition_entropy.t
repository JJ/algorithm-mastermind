...
BEGIN {
	use_ok( 'Algorithm::MasterMind::Partition_Entropy' );
}

my $secret_code = 'ADCB';
my @alphabet = qw( A B C D E F );
my $solver = new Algorithm::MasterMind::Partition_Entropy { alphabet => \@alphabet,
							   length => length( $secret_code ) };

isa_ok( $solver, 'Algorithm::MasterMind::Partition_Entropy', 'Instance OK' );
