...
BEGIN {
	use_ok( 'Algorithm::MasterMind::Partition_Combined' );
}

my $secret_code = 'ADCB';
my @alphabet = qw( A B C D E F );
my $solver = new Algorithm::MasterMind::Partition_Combined { alphabet => \@alphabet,
							   length => length( $secret_code ) };

isa_ok( $solver, 'Algorithm::MasterMind::Partition_Combined', 'Instance OK' );
