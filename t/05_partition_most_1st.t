...
BEGIN {
	use_ok( 'Algorithm::MasterMind::Partition_Most_1st' );
}

my $secret_code = 'ADCB';
my @alphabet = qw( A B C D E F );
my $solver = new Algorithm::MasterMind::Partition_Most_1st { alphabet => \@alphabet,
							   length => length( $secret_code ) };

isa_ok( $solver, 'Algorithm::MasterMind::Partition_Most_1st', 'Instance OK' );
